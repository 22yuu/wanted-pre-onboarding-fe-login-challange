...
const users: User[] = [
  { username: 'blue', password: '1234', userInfo: { name: 'blueStragglr' } },
  { username: 'white', password: '1234', userInfo: { name: 'whiteRwarf' } },
  { username: 'red', password: '1234', userInfo: { name: 'redGiant' } },
];
